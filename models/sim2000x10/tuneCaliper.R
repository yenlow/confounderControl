# To simulated data 2000x10, perform similarity search 
...
desiredOrder=c("n1","ORmatched","ORlow_matched","ORupp_matched","coeff_matched","se_matched","bias_matched","inCI_matched",
               ...
               "SMD","KS","KL","Cstat")
nsds=rev(c(0,1,1.5,2,2.5,3,10,1000))
...
save(resultsArrayCal,trueORvec,trueSMDvec,trueCoeffvec,file="tuneCalSim.RData")
