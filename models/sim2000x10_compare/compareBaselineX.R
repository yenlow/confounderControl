...
png("sim2000x10_hdPSImpt.png",width=11,height=7,units="in",res=300,bg="transparent")
barplot(timesSel_hdps[10:1],horiz=TRUE,las=1,main="Number of times selected by hdPS")
dev.off()
...
png("sim2000x10_rfImpt.png",width=11,height=7,units="in",res=300,bg="white")
...
png("sim2000x10_heatmap_pval.png",width=6.5,height=7,units="in",res=150,bg="transparent")
...
png("sim2000x10_heatmap_smd.png",width=6.5,height=7,units="in",res=150,bg="transparent")
heatmap.2(abs(smdmat),Rowv=F,Colv=F,scale="none",col=colscale,
          trace="none",keysize=1,density.info="none")
dev.off()

png("sim2000x10_heatmap_varsel.png",width=6.5,height=7,units="in",res=150,bg="transparent")
