...
apply(abs(resultsArray[,c("bias_matched","bias_adj"),]),c(1,2),mean,na.rm=T)
...
#violin plot for OR
vioplot2list(ORmatched,list2=ORadj,xticks=c(.1,1,5),log=TRUE,ref=1,legendpos="bottomright",
             title="OR (simulated data: 2000 rows x 10 variables)",
             legendtext=c("OR_matched","OR_adjusted"),outfile="OR_violin_sim2000x10.png")
vioplot2list(bias_matched,list2=bias_adj,xticks=seq(0,2,by=1),log=FALSE,ref=0,legendpos="bottomright",
             ...
             legendtext=c("Bias_matched","Bias_adjusted"),outfile="bias_violin_sim2000x10.png")
vioplot2list(se_matched,list2=se_adj,xticks=seq(0,1,by=0.5),log=FALSE,ref=0,legendpos="bottomright",
             ...
             legendtext=c("SE_matched","SE_adjusted"),outfile="SE_violin_sim2000x10.png")
...
vioplot2list(ORmatched,list2=ORadj,xticks=c(.1,50),log=TRUE,ref=10,legendpos="bottomright",
             title="OR (simulated data: 2000 rows x 10 variables)",
             legendtext=c("OR_matched","OR_adjusted"),outfile="violinAnatomy.png")
...
png(file="coverage_barplot_sim2000x10.png",width=5,height=5,units="in",res=150)
par(mar=c(2,6.5,2,0.5))
barplot(t(reportmat),beside=T,horiz=TRUE,main="Coverage of true OR within 95% CI (sim data: 2000 x 10 var)",
